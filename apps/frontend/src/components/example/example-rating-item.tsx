...
import ExampleRatingDeleteDialog from './example-rating-delete-dialog'
import { useState } from 'react'

interface ExampleRatingItemProps {
  user: {
    id: string
    name: string
    photoURL: string
...
export default function ExampleRatingItem({
  rate,
  user: author,
  ratingId,
  comment,
  createdAt,
}: ExampleRatingItemProps) {
  const { user } = useUser()
